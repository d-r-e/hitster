...
const messages = {
  'en-US': {
    tagline: 'Build your music timeline.', nickname: 'Your nickname', nicknamePlaceholder: 'e.g. David', createRoom: 'Create a room', orJoin: 'or join friends', roomCode: 'Room code', joinRoom: 'Join room', privateRoom: 'Private room', leave: 'Leave',
    lobby: 'Lobby', lobbyHelp: 'Share the room code with everyone around the same speaker. The DJ plays too and keeps their own board.', players: '{count}/8 players', waitingDj: 'Waiting for the DJ to start…', dj: 'DJ',
  ...
  'es-ES': {
    tagline: 'Construye tu línea musical.', nickname: 'Tu nombre', nicknamePlaceholder: 'p. ej. David', createRoom: 'Crear sala', orJoin: 'o únete a tus amigos', roomCode: 'Código de sala', joinRoom: 'Entrar en la sala', privateRoom: 'Sala privada', leave: 'Salir',
    lobby: 'Sala de espera', lobbyHelp: 'Comparte el código con todos los que estén junto al mismo altavoz. El DJ también juega y conserva su propio tablero.', players: '{count}/8 jugadores', waitingDj: 'Esperando a que el DJ empiece…', dj: 'DJ',
